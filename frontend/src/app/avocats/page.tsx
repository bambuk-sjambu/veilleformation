...
export const metadata: Metadata = {
  ...
  description:
    "Décisions Cassation et Conseil d'État, déontologie CNB, conventions client. La veille jurisprudence automatisée par IA Anthropic Claude. Solo 39€/an. 14 jours d'essai.",
