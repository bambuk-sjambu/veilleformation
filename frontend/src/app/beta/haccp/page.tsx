...
export const metadata = {
  ...
  description:
    "Veille réglementaire IA pour restaurateurs, boulangers, traiteurs et industriels agroalimentaires. Décrets DGAL, alertes RASFF, GBPH classés par IA Anthropic Claude. 39€/an.",
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-lg sm:text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              ...
              <br />
              <strong className="text-gray-900">39€/an.</strong>
            </p>
