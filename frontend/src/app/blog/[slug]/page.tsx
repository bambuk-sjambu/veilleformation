...
export async function generateMetadata({
  ...
  const canonicalUrl = `https://${sector.brand.domain}/blog/${slug}/`;
  ...
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: `https://${sector.brand.domain}/og-blog-${slug}.jpg`,
          width: 1200,
          height: 630,
          alt: article.title,
        },
...
export default async function BlogArticlePage({
  ...
  const articleSchema = {
    ...
    description: article.meta_description,
    image: `https://${sector.brand.domain}/og-blog-${slug}.jpg`,
    ...
    author: {
      ...
      url: `https://${sector.brand.domain}/blog/auteurs/${author.slug}/`,
    },
    publisher: {
      "@type": "Organization",
      ...
      logo: {
        "@type": "ImageObject",
        url: `https://${sector.brand.domain}/logo.png`,
        width: 200,
        height: 60,
      },
    },
    ...
    itemListElement: [
      {
        ...
        position: 1,
        name: "Accueil",
        item: `https://${sector.brand.domain}/`,
      },
      {
        "@type": "ListItem",
        position: 2,
        name: "Blog",
        item: `https://${sector.brand.domain}/blog/`,
      },
      {
        "@type": "ListItem",
        position: 3,
