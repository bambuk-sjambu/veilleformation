...
export const metadata: Metadata = {
  ...
  description:
    "Décrets DGAL, alertes RappelConso et RASFF, audit DGCCRF prêt. La veille HACCP réglementaire automatisée par IA. Newsletter gratuite, Solo 39€/an. 14 jours d'essai.",
